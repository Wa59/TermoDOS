; assemble with: yasm -fbin -otermodos.com.br termodos.asm
...
title:      db "T E R M O D O S", 0  ; string constant (put here b/c it looks nice)
...
; end message
    db 13,10
endmsg:
    db "TermoDOS - Term.ooo para MS-DOS", 13,10
    db 13, 10
...
s_gameover: db "Fim de jogo! A palavra era:", 0
s_unknown:  db "Nao e uma palavra.", 0
s_winmsg1:  db "Genial!",0
s_winmsg2:  db "Magnifico!",0
s_winmsg3:  db "Muito bom!",0
s_winmsg4:  db "Esplendido!",0
s_winmsg5:  db "Otimo!",0
s_winmsg6:  db "Ufa!",0
